...
import BoardJoinModal from '../../components/Board/BoardJoinModal';
...
const Boards = ({ modal }) => {
  ...
  return (
    <MainLayout clearFit={false}>
      ...
      <BoardList />
      {
        modal.modalIsActive && modal.type === 'create' &&
        <BoardCreateModal />
      }
      {
        modal.modalIsActive && modal.type === 'join' &&
        <BoardJoinModal />
      }
